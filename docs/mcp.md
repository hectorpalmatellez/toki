...
|---|---|---|---|
| `input` | `string` | yes | Path to the token file |
| `format` | `OutputFormat` | yes | Target format: `css`, `js`, `react-native`, `angular`, `angular-11`, `svelte`, `react`, `stencil` |
...
```
→ calls list_formats({})
← { formats: ["css", "js", "react-native", "angular", "angular-11", "svelte", "react", "stencil"] }
```
...
```json
{
  ...
  "tokiReference": {
    ...
    "outputFormats": ["css", "js", "react-native", "angular", "angular-11", "svelte", "react", "stencil"],
