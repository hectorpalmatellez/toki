...
export type ColorToken = 'color.primary' | 'color.secondary';

export type SpacingToken = 'spacing.small' | 'spacing.medium';

export type FontToken = 'font.sans';

export type TokenName = ColorToken | SpacingToken | FontToken;
```
