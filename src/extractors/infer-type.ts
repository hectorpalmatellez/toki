...
const FONT_FAMILY_GENERIC =
  /(?:sans-serif|serif|monospace|cursive|fantasy|system-ui|ui-|Noto|Helvetica|Arial|Georgia|Verdana|Times|Courier|Inter|Roboto|Open Sans|Fira)/i;
