...
Toki ingests W3C Design Tokens Community Group (DTCG) format JSON and generates idiomatic, framework-specific code artifacts for seven target platforms: CSS, JavaScript, React Native, Angular (latest + v11), Svelte, and React/Next.js.
...
- **Seven output formats** — CSS, JS, React Native, Angular (latest + v11), Svelte, React/Next.js
...
| [Output Guide](docs/output.md)       | Input format (W3C DTCG), output conventions, code examples for all 7 platforms              |
...
| CLI             | Commander.js                                      |
| Bundler         | tsup                                              |
| Testing         | Vitest (281 tests, 90%+ coverage)                 |
| Linting         | oxlint                                            |
| Formatting      | Prettier                                          |
